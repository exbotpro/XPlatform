...
while 1:
	...
	darry = data.split(':')
	speeds = darry[0].split(' ')
	speedOfM1 = int(speeds[1])
	speedOfM2 = int(speeds[0])
	if speedOfM1 >0 :
		if speedOfM1==0: M1Forward(10)
		else : M1Forward(speedOfM1)
		
	else:
		if speedOfM1==0: M1Forward(10)
		else : M1Forward(speedOfM1*(-1))
		
	if speedOfM2 >0 :
		if speedOfM2==0: M2Forward(10)
		else : M2Forward(speedOfM2)
	else:
		if speedOfM2==0: M2Forward(10)
		else : M2Forward(speedOfM2*(-1))
	buf = "";
conn.close()
